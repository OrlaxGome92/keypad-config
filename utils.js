// utils.js - Expanded for 6-Key + Knob Hardware (1189:8890)
...
export const SCAN_CODES = {
    ...
    "Backslash": 0x31, "Semicolon": 0x33, "Quote": 0x34, "Tilde": 0x35, "Comma": 0x36,
    "Dot": 0x37, "Slash": 0x38,

    // Navigation & Editing
    "Enter": 0x28, "Esc": 0x29, "Backspace": 0x2A, "Tab": 0x2B, "Caps": 0x39,
    ...
    // Layer Switching Keys (Hidden Windows Triggers)
    // These are perfect for your software layer switching logic
    "F13": 0x68, "F14": 0x69, "F15": 0x6A, "F16": 0x6B, "F17": 0x6C, "F18": 0x6D,
    "F19": 0x6E, "F20": 0x6F, "F21": 0x70, "F22": 0x71, "F23": 0x72, "F24": 0x73,

    // Knob / Multimedia Actions (Consumer Page)
    "Mute": 0xEF, 
    "VolUp": 0xED, 
    "VolDown": 0xEE, 
    "PlayPause": 0xE8, 
    ...
    "Prev": 0xEA, 
    "Next": 0xEB,
    "Calc": 0xFB,      // Launch Calculator
    "MyComputer": 0xFC, // Open Explorer
};
